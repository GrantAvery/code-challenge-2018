import { SimpleCodeClash, PlayerActions, determineAggressor } from './simple-code-clash.js';

let { TRAIN_ATTACKER, BUILD_DEFENSE, ATTACK } = PlayerActions;
...
describe('Simple Code Clash Game', () => {
  ...
  describe('play turn', () => {
    ...
    it('should allow only recognized player choices, else "INVALID_ACTION"', () => {
      ...
      let expected = [TRAIN_ATTACKER, BUILD_DEFENSE, ATTACK, 'INVALID_ACTION'];
